...
📦 インストール
｀｀｀bash npm install milkdown-plugin-novel-japanese ｀｀｀

🚀 使用方法
Next.js プロジェクトでの使用例：

｀｀｀tsx import { Editor, rootCtx } from '@milkdown/core'; import { nord } from '@milkdown/theme-nord'; import { commonmark } from '@milkdown/preset-commonmark'; import { japaneseNovel } from 'milkdown-plugin-novel-japanese';
